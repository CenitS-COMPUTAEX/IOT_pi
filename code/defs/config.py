...
class Config:
	...
	# File used to launch the flood attack
	flood_executable_file: str
	# Delay between packets, in microseconds
	flood_delay_micro: int
	# Number of threads to use for the port scan attack
	port_scan_num_threads: int
	# Time between port checks, in seconds
	port_scan_delay: float
	# Timeout to wait for a server response, in seconds
	...
	def __init__(self):
		...
		flood_element = attacks_element.find("Flood")
		self.flood_executable_file = flood_element.find("FileToRun").text
		self.flood_delay_micro = int(flood_element.find("Delay").text)

		port_scan_element = attacks_element.find("PortScan")
		self.port_scan_num_threads = int(port_scan_element.find("NumThreads").text)
		self.port_scan_delay = float(port_scan_element.find("Delay").text)
		self.port_scan_timeout = float(port_scan_element.find("Timeout").text)
